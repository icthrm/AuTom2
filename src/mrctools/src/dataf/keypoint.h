...
inline static int WriteFeaturesByName(const std::vector<feature>& feats, const char* filename) 
{
...
inline static int ReadFeaturesByName(std::vector<feature>* feats, const char* filename)
{
