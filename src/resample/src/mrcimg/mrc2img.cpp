...
// util::MrcStack CreateNewMrc(const char *filename, int nx, int ny, int nz, Mode mode)
// {
//     util::MrcStack mrc;
//     mrc.AllocHeader();
//     mrc.SetVolumeSize(nx, ny, nz);
//     mrc.SetHeader(mode, 0, 0, 0);
//     mrc.SetName(filename);
//     mrc.WriteHeaderToFile();
//     return mrc;
// }
