...
public:	
    ...
    static void MatchMain(util::FiducialStack& fstack, const std::vector< float >& angles, util::ImgMatchVector* imvector, HSetVector* hsetvec, float dist_err_tol, bool method, bool eigenlimit = true, bool do_test = false); //dist_err_tol = half radius
